    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center py-12">
                ...
                <span className="ml-3 text-neutral-500">生成风险分析中...</span>
            </div>
        );
    }
                ...
                {riskAnalysis.rsi && (
                    <div className="text-center">
                        ...
                        <div className={`text-lg font-bold ${
                            riskAnalysis.rsi > 70 ? "text-red-600" : riskAnalysis.rsi < 30 ? "text-emerald-600" : "text-neutral-900 dark:text-white"
                        }`}>
