...
const stepColors: Record<string, string> = {
  "观察": "text-neutral-500 bg-neutral-100",
  ...
  return (
    <div className="space-y-4 py-4">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-sm font-bold text-neutral-800 uppercase tracking-wider">AI 思辨逻辑链 (Thought Process)</h3>
      </div>
          ...
          {steps.map((item, index) => (
            <div key={index} className="relative pl-8">
              ...
              <div className={clsx(
                ...
                stepColors[item.step] || "bg-neutral-100 text-neutral-500"
              )}>
              ...
              <div className="flex flex-col gap-1">
                <span className={clsx(
                  ...
                  stepColors[item.step]?.split(' ')[0] || "text-neutral-500"
                )}>
                  {item.step}
                </span>
