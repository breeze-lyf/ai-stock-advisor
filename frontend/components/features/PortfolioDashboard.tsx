        ...
        return (
            <div className="flex-1 flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm font-medium text-neutral-500">正在生成持仓透视...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-neutral-50 dark:bg-neutral-950 custom-scrollbar">
            <div className="grid grid-cols-12 gap-4 max-w-7xl mx-auto">
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 border border-neutral-200 dark:border-neutral-800 shadow-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="space-y-1">
                                <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">总资产净值 (Total Equity)</span>
                                <div className="flex items-baseline gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-neutral-400">USD</span>
                                </div>
                            </div>

                            <div className="flex gap-8">
                                <div className="space-y-1">
                                    <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">累计盈亏 (P/L)</span>
                                    <div className={clsx(
                                ...
                                <div className="space-y-1">
                                    <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">今日变动 (Day Change)</span>
                                    <div className={clsx(
                                        "flex items-center gap-1.5 font-bold text-lg tabular-nums",
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm overflow-hidden">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="bg-neutral-50/50 dark:bg-neutral-800/20 text-[10px] font-bold text-neutral-400 uppercase tracking-tight">
                                            ...
                                            >
                                                <td className="px-5 py-3">
                                                    <div className="flex flex-col">
                                                        <span className="font-bold text-neutral-900 dark:text-white text-sm">{item.ticker}</span>
                                                        <span className="text-[10px] text-neutral-400 truncate max-w-[100px]">{item.name}</span>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 text-right font-medium text-xs tabular-nums text-neutral-600 dark:text-neutral-400">{item.quantity}</td>
                                                <td className="px-3 py-3 text-right font-medium text-xs tabular-nums text-neutral-600 dark:text-neutral-400">${item.avg_cost.toFixed(2)}</td>
                                                <td className="px-3 py-3 text-right font-medium text-xs tabular-nums text-neutral-600 dark:text-neutral-400">${item.current_price.toFixed(2)}</td>
                                                <td className="px-3 py-3 text-right">
                                                    <span className="font-bold text-xs tabular-nums text-neutral-900 dark:text-white">${item.market_value.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                                                </td>
                                                <td className="px-3 py-3 text-right">
                                                ...
                                                <td className="px-3 py-3 text-right">
                                                    <span className="text-[10px] font-bold tabular-nums text-neutral-600 dark:text-neutral-300">
                ...
                <div className="col-span-12 lg:col-span-4 space-y-4">
                    ...
                    <div className="bg-neutral-900 dark:bg-blue-950/20 rounded-2xl p-5 border border-neutral-800 dark:border-blue-900/30 shadow-sm relative overflow-hidden group">
                        ...
                        {(!analysis && loadingAnalysis) ? (
                            <div className="py-8 flex flex-col items-center justify-center gap-3 animate-pulse">
                                ...
                                <p className="text-neutral-500 text-[10px] font-bold">同步历史诊断...</p>
                            </div>
                        ) : !analysis ? (
                            <div className="py-6 flex flex-col items-center text-center gap-3">
                                ...
                                <div className="space-y-1">
                                    <p className="text-neutral-300 text-xs font-bold">获取 AI 专业意见</p>
                                    <p className="text-neutral-500 text-[10px] px-4">审视组合风险、行业集中度并获得策略建议。</p>
                                </div>
                                {analyzeError && (
                                ...
                                <div className="flex gap-2">
                                    <Dialog open={showReport} onOpenChange={onShowReportChange}>
                                        <DialogTrigger asChild>
                                            <Button 
                                                variant="secondary"
                                                className="flex-1 bg-neutral-800 hover:bg-neutral-700 text-white font-bold rounded-xl h-9 text-[10px] gap-1.5"
                                            >
                                                <BookOpen className="h-3 w-3" />
                                                深度报告
                                            </Button>
                                        </DialogTrigger>
                                        <DialogContent className="max-w-2xl bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 p-0 overflow-hidden rounded-2xl">
                                            <DialogHeader className="p-5 border-b border-neutral-100 dark:border-neutral-800 flex flex-row items-center justify-between bg-neutral-50/50 dark:bg-neutral-800/20 space-y-0 text-left">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-xl bg-blue-600/10 flex items-center justify-center border border-blue-600/20">
                                                        <BrainCircuit className="h-4 w-4 text-blue-600" />
                                                    </div>
                                                    <div className="text-left">
                                                        <DialogTitle className="font-bold text-base text-neutral-900 dark:text-white leading-tight">
                                                            AI 深度诊断报告
                                                        </DialogTitle>
                                            ...
                                            <ScrollArea className="h-[50vh] p-6">
                                                <div className="prose prose-slate dark:prose-invert max-w-none text-xs prose-p:text-neutral-600 dark:prose-p:text-neutral-400 prose-headings:text-neutral-900 dark:prose-headings:text-white prose-strong:text-neutral-900 dark:prose-strong:text-white">
                                                    <ReactMarkdown remarkPlugins={[remarkGfm]}>{analysis.detailed_report}</ReactMarkdown>
                                                </div>
                                            </ScrollArea>
                                            
                                            <div className="p-3 bg-neutral-50 dark:bg-neutral-800/30 border-t border-neutral-100 dark:border-neutral-800 flex justify-between items-center text-[10px]">
                                                <span className="font-bold text-neutral-400">报告生成时间: {new Date(analysis.created_at).toLocaleString()}</span>
                                    ...
                                    <Button 
                                        ...
                                        onClick={onAnalyze}
                                        disabled={analyzing}
                                        className="bg-transparent border-neutral-700 hover:bg-neutral-800 text-neutral-400 font-bold rounded-xl h-9 px-2.5"
                                    >
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-2xl p-5 border border-neutral-200 dark:border-neutral-800 shadow-sm">
                            ...
                            {summary?.sector_exposure.sort((a, b) => b.value - a.value).map((s, idx) => (
                                <div key={idx} className="space-y-1">
                                    <div className="flex justify-between text-[10px] font-bold uppercase tracking-tight">
                                        <span className="text-neutral-500 dark:text-neutral-400">{s.sector === "Unknown" ? "未归类/其他" : s.sector}</span>
                        ...
                        <div className="mt-6 p-3 bg-neutral-50 dark:bg-neutral-800/20 rounded-xl border border-neutral-100 dark:border-neutral-800 text-center">
