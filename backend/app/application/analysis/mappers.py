...
def serialize_analysis_report(
    ...
    return {
        ...
        "confidence_breakdown": raw_payload.get("confidence_breakdown") if isinstance(raw_payload.get("confidence_breakdown"), dict) else None,
        "key_assumptions": _list_of_dicts_or_none(raw_payload.get("key_assumptions")),
        "catalysts": _list_of_dicts_or_none(raw_payload.get("catalysts")),
